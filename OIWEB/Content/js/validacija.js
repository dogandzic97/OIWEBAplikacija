...
function proveriPretplatnickiBroj(){
	...
	if(pretplatnickiBroj==null || pretplatnickiBroj==''){
		document.getElementById('PretplatnickiBroj').style.color = "red";
		return false;
	}
	else{
...
function proveriNazivPravnogLica(){
	...
	if(nazivPravnogLica==null || nazivPravnogLica==''){
		document.getElementById('NazivPravnogLica').style.color = "red";
		return false;
	}else{
		return true;
	}
...
function proveriBrojTekucegRacuna(){
	...
	if(brojTekucegRacuna==null || brojTekucegRacuna==''){
		document.getElementById('BrojTekucegRacuna').style.color = "red";
		return false;
	}
	else{
		return true;
...
function proveriUlicaIBroj(){
	...
	if(ulicaIBroj==null || ulicaIBroj==''){
		document.getElementById('UlicaIBroj').style.color = "red";
		return false;
	}
	else{
		return true;
...
function proveriFaks(){
	...
	if(faks==null || faks==''){
		document.getElementById('Faks').style.color = "red";
		return false;
	}
	else{
		return true;
